...
func TestTriangulateOrder3(t *testing.T) {
	// TODO: Create a test to triangulate an RT4 element, which currently fails
	// Geometry for an RT4 element, an equilateral triangle
	VX := []float64{-2.5, 2.5, 0.}
	VY := []float64{-1.44338, -1.44338, 2.88675}
	FluxX := []float64{0.00000, 0.00000, -2.08181, 2.08181, -0.54857, -0.87143,
		0.87143, -1.42000, 0.54857, 1.42000, 0.00000, 0.00000, -2.08181, 2.08181,
		-0.54857, -0.87143, 0.87143, -1.42000, 0.54857, 1.42000, -2.26545,
		-1.34617, 0.00000, 1.34617, 2.26545, 2.38272, 1.92309, 1.25000, 0.57691,
		0.11728, -0.11728, -0.57691, -1.25000, -1.92309, -2.38272}
	FluxY := []float64{0.00000, 2.40386, -1.20193, -1.20193, 1.32296, -1.13655,
		-1.13655, -0.18640, 1.32296, -0.18640, 0.00000, 2.40386, -1.20193,
		-1.20193, 1.32296, -1.13655, -1.13655, -0.18640, 1.32296, -0.18640,
