...
func TestSimplex3DPNormalization(t *testing.T) {
	...
	// Based on the orthonormal Jacobi polynomial values:
	// P_{0,0,0} = 2√2 × P_0^{0,0} × P_0^{1,0} × P_0^{2,0}
	// P_{0,0,0} = 2√2 × (1/√2) × (1/√2) × √(3/8)
	// P_{0,0,0} = 2√2 × (1/2) × √(3/8) = √2 × √(3/8) = √(3/4) = √3/2
	...
	// The expected value is sqrt(3)/2 based on the corrected orthonormal Jacobi polynomial values
	expectedNorm := math.Sqrt(3.0) / 2.0 // √3/2 ≈ 0.866025
